...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarBackgroundImage = [UIImage qmui_imageWithColor:UIColorWhite];
...
//    QMUICMI.navBarBarTintColor = nil;                                           // NavBarBarTintColor : UINavigationBar.barTintColor，也即背景色
    ...
    QMUICMI.navBarTitleFont = [UIFont fontWithName:@"Papyrus" size:18];
    //UIFontPFMediumMake(17);                               // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
